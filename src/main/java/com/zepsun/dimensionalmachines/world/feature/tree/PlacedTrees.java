...
public class PlacedTrees {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, TRANSPAR_PLACED_KEY, configuredFeatures.getOrThrow(TreeFeatures.TRANSPAR_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2), (Block) ModBlocks.TRANSPAR_SAPLING.get()));
    }
